...
function renderWorkspaceChat(conversationId){
  document.getElementById('workspace-chat').style.display = 'block';
  const chatBox = document.getElementById('chat-messages');
  chatBox.innerHTML = '<p style="text-align:center;color:#888;">Loading chat...</p>';

  // fake fallback if no firebase
  if(typeof db === 'undefined'){
    chatBox.innerHTML = '<p>No backend connected</p>';
    return;
  }

  // your existing openConv if available
