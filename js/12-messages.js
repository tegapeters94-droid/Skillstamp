...
window.openMsg=async function(uid){
  ...
  // Go to messages page (this calls backToInbox which sets up the layout)
  // then open the specific conversation once layout is ready
  showPage('messages');
  setTimeout(function(){ openConv(cid); }, 600);
};
