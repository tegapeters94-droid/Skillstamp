...
function showContactWarning(label, originalText, maskedText, onSendAnyway, onCancel) {
  ...
  banner.innerHTML =
    ...
    + '<div style="flex:1;">'
    + '<div style="font-family:Syne,sans-serif;font-weight:800;font-size:13px;color:#9a3412;margin-bottom:4px;">Off-Platform Contact Detected</div>'
    ...
    + '<button id="warn-cancel" style="flex:1;background:#fff;border:1px solid #fed7aa;color:#374151;font-family:Syne,sans-serif;font-weight:700;font-size:11px;padding:8px;border-radius:8px;cursor:pointer;">Edit Message</button>'
    + '<button id="warn-send" style="flex:1;background:#fff7ed;border:1px solid #ea580c;color:#ea580c;font-family:Syne,sans-serif;font-weight:700;font-size:11px;padding:8px;border-radius:8px;cursor:pointer;">Send Anyway</button>'
    + '</div>'
    + '</div>'
...
window.openMsg = async function(uid) {
  ...
  setModal(
    ...
    '<div style="font-family:Syne,sans-serif;font-weight:700;font-size:13px;">Loading chat…</div>' +
    '</div>' +
  ...
  try {
    ...
    var avHTML = other.avatar
      ...
      : '<div style="width:36px;height:36px;border-radius:50%;background:linear-gradient(135deg,' + other.gradient + ',' + other.gradient + '88);display:flex;align-items:center;justify-content:center;font-family:Syne,sans-serif;font-weight:800;font-size:13px;color:#000;flex-shrink:0;">' + initials(other.name) + '</div>';
    ...
    mc2.innerHTML =
      ...
      + '<div style="font-family:Syne,sans-serif;font-weight:700;font-size:13px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">' + other.name + '</div>'
