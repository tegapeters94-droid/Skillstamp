...
window.closeModal = function() {
  // Cancel any in-progress openMsg call so it doesn't re-apply fullscreen styles
  if (window._openMsgToken) { window._openMsgToken.cancelled = true; window._openMsgToken = null; }
  if (window._chatUnsub) { try { window._chatUnsub(); } catch(e) {} window._chatUnsub = null; }
