...
window.openMsg = async function(uid) {
  ...
  try {
    ...
    mc2.style.padding = '0';
    mc2.style.width = '100%';
    mc2.style.maxWidth = '100%';
    mc2.style.height = '100vh';
    mc2.style.maxHeight = '100vh';
    mc2.style.borderRadius = '0';
    ...
    mc2.innerHTML =
      ...
      + '<input id="chat-input" class="fi no-icon" placeholder="Type a message…" style="flex:1;margin:0;font-size:13px;padding:11px 12px;min-height:42px;" autocomplete="off">'
