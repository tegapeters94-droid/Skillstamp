...
function buildProfile(u,isOwn){
  ...
  if(isClient){
    ...
    statsRow='<div class="pstats">'
      +'<div class="pstat"><span class="pstat-icon">⭐</span><div style="display:flex;gap:2px;justify-content:center;margin-bottom:4px;">'+_sh+'</div><div class="psval" style="color:'+_rc+';">'+_rt+'</div><div class="pslbl">Rating</div></div>'
      +'<div class="pstat"><span class="pstat-icon">💼</span><div class="psval">'+(u.gigsCount||0)+'</div><div class="pslbl">Gigs Done</div></div>'
      +'<div class="pstat"><span class="pstat-icon">💰</span><div class="psval" style="color:var(--grn);">$'+(((u.wallet&&u.wallet.earned)||u.earned||0).toLocaleString())+'</div><div class="pslbl">Earned</div></div>'
      +'</div>';
  }
