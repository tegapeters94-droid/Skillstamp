...
window.openTopUp=function(){
  ...
  [10,20,30,40,50].forEach(function(a){
    html+='<div style="padding:14px;background:var(--s2);border:1px solid var(--br);border-radius:var(--r);text-align:center;cursor:pointer;font-family:Syne,sans-serif;font-weight:700;" onclick="setTopUpAmt('+a+')">$'+a+'</div>';
  });
  html+='</div>';
