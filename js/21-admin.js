...
window.adminApprove=function(pid){
  ...
  toast(`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4ade80" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg> "${p.skill}" approved! +10 pts`);renderAdmin();
};
...
window.adminReject=function(pid){
  ...
  savePending(pending);toast(`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ef4444" stroke-width="2.5"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg> Rejected. -10 pts.`,'bad');renderAdmin();
};
