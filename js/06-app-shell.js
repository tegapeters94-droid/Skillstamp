...
window.openGigWorkspace=async function(gid){
  ...
  setTimeout(function(){
    ...
    setTimeout(function(){var mb=document.getElementById('ws-msg');if(mb)mb.onclick=function(){closeModal();setTimeout(function(){openMsg(isClient?gig.hiredUid:gig.posterUid);},100);};},50);
  },50);
};
