...
window.openGigWorkspace=async function(gid){
  ...
  setTimeout(function(){
    ...
    // Wire message button — attach handler directly to avoid setTimeout race
    ...
    function _openWsChat(e) {
      if (e) { e.preventDefault(); e.stopPropagation(); e.stopImmediatePropagation(); }
      // Set global guard — moverlay onclick checks this before closing
      ...
      openMsg(_chatUid);
      // Clear guard after chat has had time to render
      setTimeout(function() { window._chatOpening = false; }, 1000);
    }
    msgBtn.addEventListener('touchstart', function(e) { e.stopPropagation(); }, {passive: false});
    msgBtn.addEventListener('touchend', function(e) { e.preventDefault(); e.stopPropagation(); _openWsChat(e); }, {passive: false});
    msgBtn.addEventListener('click', function(e) { _openWsChat(e); });
