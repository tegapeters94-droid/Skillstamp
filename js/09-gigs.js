...
function openProposalCredits(){
  setModal('<button class="mclose" onclick="closeModal()">✕</button>'
    ...
    +'<div style="font-family:Syne,sans-serif;font-weight:800;font-size:16px;margin-bottom:6px;">Proposal Credits</div>'
    ...
    +'<div><div style="font-family:Syne,sans-serif;font-weight:700;font-size:13px;">Starter Pack</div><div style="font-size:11px;color:var(--td);">5 extra proposals</div></div>'
    +'<div style="font-family:Syne,sans-serif;font-weight:800;font-size:15px;color:var(--gld);">$3</div>'
    +'</div></div>'
    ...
    +'<div style="position:absolute;top:-8px;right:12px;background:var(--gld);color:#000;font-size:8px;font-weight:800;padding:2px 8px;border-radius:8px;font-family:Syne,sans-serif;">BEST VALUE</div>'
    +'<div style="display:flex;justify-content:space-between;align-items:center;">'
    +'<div><div style="font-family:Syne,sans-serif;font-weight:700;font-size:13px;">Pro Pack</div><div style="font-size:11px;color:var(--td);">15 extra proposals</div></div>'
    +'<div style="font-family:Syne,sans-serif;font-weight:800;font-size:15px;color:var(--gld);">$8</div>'
    +'</div></div>'
    +'</div>'
...
window.applyGig=async function(gid,title,posterUid){
  ...
  mh+='<div><div style="font-family:Syne,sans-serif;font-weight:800;font-size:15px;color:var(--tx);">Submit Proposal</div>';
  ...
  setTimeout(function(){
    ...
    if(submitBtn) submitBtn.onclick=async function(){
      ...
      mhtml+='<div style="font-family:Syne,sans-serif;font-weight:800;font-size:18px;letter-spacing:-.03em;margin-bottom:6px;color:var(--tx);">Proposal Sent!</div>';
