...
window.openSettings = function() {
  ...
  var proItem = !isPro ? [{
    ...
    onclick: "document.getElementById('settings-panel').remove(); alert('Pro plan active. Tier: ' + getTierLabel(ME) + '. Monthly bids: ' + getMonthlyBidLimit(ME) + '.');" 
  }];
  var businessItem = isClient ? [{
    ...
    onclick: isBusiness ? "document.getElementById('settings-panel').remove(); settingsNav('businessmode')" : "settingsNav('businessmode')" 
  }] : [];
