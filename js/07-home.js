...
function fHero() {
  ...
  html += '<button onclick="showPage(\'gigs\')" style="flex:1;'+D.font+';font-weight:700;font-size:11px;color:#000;background:#e8c547;border:none;padding:10px;border-radius:10px;cursor:pointer;'+D.trans+'" onmouseover="this.style.background=\'#f5d460\'" onmouseout="this.style.background=\'#e8c547\'">💼 Browse Gigs</button>';
...
function fFAB(role) {
  ...
  return '<div style="position:fixed;bottom:88px;right:16px;z-index:200;">'
    + '<button onclick="'+onclick+'" style="'+D.font+';font-weight:800;font-size:12px;color:#000;background:var(--gld);border:none;padding:12px 18px;border-radius:24px;cursor:pointer;box-shadow:0 4px 16px rgba(232,197,71,.5);'+D.trans+'" onmouseover="this.style.transform=\'scale(1.05)\'" onmouseout="this.style.transform=\'\'">'+label+'</button>'
    + '</div>';
}
...
function cHero() {
  ...
  html += '<button onclick="openPostGig()" style="flex:1;'+D.font+';font-weight:800;font-size:11px;color:#000;background:#e8c547;border:none;padding:10px;border-radius:10px;cursor:pointer;'+D.trans+'" onmouseover="this.style.background=\'#f5d460\'" onmouseout="this.style.background=\'#e8c547\'">+ Post a Gig</button>';
