...
window.confirmHire=async function(gid){
  ...
  mh+='</div>';
  mh+='<button class="btn" style="width:100%;margin-bottom:10px;" onclick="closeModal();setTimeout(function(){openMsg(\''+hiredUid+'\');},150);">Open Chat with '+hiredUser.name+' →</button>';
