...
function renderLearnV6(){
  ...
  for(var ci2=0;ci2<fil.length;ci2++){
    ...
    if(c.free){
      cardsH+='<span style="position:absolute;top:8px;right:8px;background:var(--grn);color:#000;font-size:8px;font-weight:700;padding:2px 7px;border-radius:4px;font-family:Syne,sans-serif;">FREE</span>';
    } else {
    ...
    if(enrolled){
      cardsH+='<span style="position:absolute;top:8px;left:8px;background:rgba(96,165,250,.9);color:#000;font-size:8px;font-weight:700;padding:2px 7px;border-radius:4px;font-family:Syne,sans-serif;">ENROLLED</span>';
    }
    cardsH+='</div>';
  ...
  return '<div class="learn-hero">'
    ...
    +'<div><div style="font-family:Syne,sans-serif;font-weight:800;font-size:22px;letter-spacing:-.5px;">SkillStamp <span style="color:var(--blu);">Learn</span></div>'
    +'<div style="font-size:11px;color:var(--td);margin-top:2px;">Master skills. Get verified. Get hired.</div></div></div>'
    +'<div style="display:flex;gap:18px;flex-wrap:wrap;">'
    +'<div><span style="font-family:Syne,sans-serif;font-weight:800;font-size:20px;color:var(--grn);">'+COURSES.length+'</span><div style="font-size:9px;color:var(--td);">Courses</div></div>'
    +'<div><span style="font-family:Syne,sans-serif;font-weight:800;font-size:20px;color:var(--gld);">'+freeCount+'</span><div style="font-size:9px;color:var(--td);">Free</div></div>'
    +'<div><span style="font-family:Syne,sans-serif;font-weight:800;font-size:20px;color:var(--blu);">'+enr.length+'</span><div style="font-size:9px;color:var(--td);">Enrolled</div></div>'
    +'</div></div>'
...
function openCourseV6(cid){
  ...
  var body='<button class="mclose" onclick="closeModal()">✕</button>'
    ...
    +'<div><div style="font-family:Syne,sans-serif;font-weight:800;font-size:15px;line-height:1.3;">'+c.title+'</div>'
    ...
    +'<div style="text-align:center;padding:10px;background:var(--s2);border-radius:6px;"><div style="font-family:Syne,sans-serif;font-weight:700;font-size:15px;">'+c.lessons+'</div><div style="font-size:8px;color:var(--td);">LESSONS</div></div>'
    +'<div style="text-align:center;padding:10px;background:var(--s2);border-radius:6px;"><div style="font-family:Syne,sans-serif;font-weight:700;font-size:12px;">'+c.weeks+'</div><div style="font-size:8px;color:var(--td);">DURATION</div></div>'
    +'<div style="text-align:center;padding:10px;background:var(--s2);border-radius:6px;"><div style="font-family:Syne,sans-serif;font-weight:700;font-size:15px;color:'+(c.free?'var(--grn)':'var(--gld)')+'">'+(c.free?'FREE':'$'+c.price)+'</div><div style="font-size:8px;color:var(--td);">PRICE</div></div>'
    +'</div>'
  ...
  if(enrolled){
    ...
    if(prog<100){
      ...
      body+='<div style="padding:14px;background:rgba(74,222,128,.07);border:1px solid rgba(74,222,128,.2);border-radius:var(--r);text-align:center;font-family:Syne,sans-serif;font-weight:700;color:var(--grn);margin-top:12px;">🏆 Course Completed!</div>';
    }
  } else {
