...
window.runAIVal=function(){
  ...
  document.getElementById('mcontent').innerHTML=`<div style="text-align:center;padding:28px;">
    ...
    <div style="font-family:Syne,sans-serif;font-weight:700;font-size:13px;margin-bottom:6px;">Analyzing "${skill}"…</div>
  ...
  setTimeout(()=>{
    ...
    document.getElementById('mcontent').innerHTML=`<button class="mclose" onclick="closeModal()">✕</button>
      <div style="display:flex;align-items:center;gap:16px;margin-bottom:18px;">
        ...
        <div><div style="font-family:Syne,sans-serif;font-weight:800;font-size:17px;">SkillMatch™ Score</div><div style="font-size:10px;color:var(--td);margin-top:2px;">for "${skill}"</div><div style="margin-top:7px;">${badgeHTML(status)}</div></div>
      </div>
