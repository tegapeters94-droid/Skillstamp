...
window.showBannedScreen=function(){
  ...
  html+='<div style="font-family:Syne,sans-serif;font-weight:800;font-size:20px;margin-bottom:8px;color:var(--tx);">Account Suspended</div>';
  ...
  html+='<a href="mailto:tegapeters94@gmail.com?subject='+subject+'&body='+body+'" style="display:block;background:var(--gld);color:#000;font-family:Syne,sans-serif;font-weight:800;font-size:12px;padding:13px 20px;border-radius:8px;text-decoration:none;">📧 Send Appeal Email</a>';
  html+='</div>';
