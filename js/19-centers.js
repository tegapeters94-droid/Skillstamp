...
function renderCentersV6(){
  ...
  for(var i=0;i<fil.length;i++){
    ...
    cardsH+='<div class="center-card">'
      ...
      +'<div style="flex:1;"><div style="font-family:Syne,sans-serif;font-weight:700;font-size:13px;margin-bottom:2px;">'+c.name+'</div>'
      +'<div style="font-size:10px;color:var(--td);">'+flag(c.country)+' '+c.city+', '+c.country+'</div>'
      +(c.verified?'<span style="display:inline-block;margin-top:3px;background:rgba(74,222,128,.1);border:1px solid rgba(74,222,128,.25);color:var(--grn);font-size:8px;padding:1px 6px;border-radius:4px;font-family:Syne,sans-serif;font-weight:700;">✓ VERIFIED</span>':'')
      +'</div>'
      +'<div style="text-align:right;flex-shrink:0;"><div style="font-family:Syne,sans-serif;font-weight:700;font-size:15px;color:var(--gld);">'+c.rating+'★</div>'
  ...
  return '<div style="padding:18px 16px 0;">'
    ...
    +'<div><div style="font-family:Syne,sans-serif;font-weight:800;font-size:20px;">Training Centers</div>'
...
function searchCentersV6(q){
  ...
  for(var i=0;i<fil.length;i++){
    ...
    h+='<div class="center-card" onclick="openCenterV6(\''+c.id+'\')" style="cursor:pointer;">'
      ...
      +'<div><div style="font-family:Syne,sans-serif;font-weight:700;font-size:13px;">'+c.name+'</div>'
...
function openCenterV6(cid){
  ...
  setModal('<button class="mclose" onclick="closeModal()">✕</button>'
    ...
    +'</div>'
    +'<div style="margin-bottom:14px;"><div style="font-family:Syne,sans-serif;font-size:11px;font-weight:700;margin-bottom:7px;">Courses Offered</div>'+crsH+'</div>'
